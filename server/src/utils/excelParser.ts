...
export function parseExcelBuffer(buffer: any, sheetName?: string): { data?: ProcessedData, sheets: string[] } {
  // Use "buffer" type for Node.js if it's a Buffer, otherwise "array"
  const type = Buffer.isBuffer(buffer) ? "buffer" : "array";
